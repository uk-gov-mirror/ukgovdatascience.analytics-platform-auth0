function (user, context, callback) {
    ...
    var namespace = 'https://api.dev.mojanalytics.xyz/claims/';  // For custom claims, you must define a namespace for oidc compliance. See https://auth0.com/docs/api-auth/tutorials/adoption/scope-custom-claims
    var options   = {
